...
# endif
# ifdef ZTS
#  define ZEND_OPCODE_HANDLER_ARGS             EXECUTE_DATA_D OPLINE_DC, void *_tsrm_ls_cache
#  define ZEND_OPCODE_HANDLER_ARGS_PASSTHRU    EXECUTE_DATA_C OPLINE_CC, _tsrm_ls_cache
#  define ZEND_OPCODE_HANDLER_ARGS_EX          EXECUTE_DATA_D OPLINE_DC, void *_tsrm_ls_cache,
#  define ZEND_OPCODE_HANDLER_ARGS_PASSTHRU_EX EXECUTE_DATA_C OPLINE_CC, _tsrm_ls_cache,
# else
